...
pub extern fn emscripten_unwind_to_js_event_loop() noreturn;
pub extern fn emscripten_set_timeout(cb: ?*const fn (?*anyopaque) callconv(.c) void, msecs: f64, user_data: ?*anyopaque) c_int;
pub extern fn emscripten_clear_timeout(id: c_int) void;
pub extern fn emscripten_set_timeout_loop(cb: ?*const fn (f64, ?*anyopaque) callconv(.c) bool, interval_ms: f64, user_data: ?*anyopaque) void;
pub extern fn emscripten_set_immediate(cb: ?*const fn (?*anyopaque) callconv(.c) void, user_data: ?*anyopaque) c_int;
pub extern fn emscripten_clear_immediate(id: c_int) void;
pub extern fn emscripten_set_immediate_loop(cb: ?*const fn (?*anyopaque) callconv(.c) bool, user_data: ?*anyopaque) void;
pub extern fn emscripten_set_interval(cb: ?*const fn (?*anyopaque) callconv(.c) void, interval_ms: f64, user_data: ?*anyopaque) c_int;
pub extern fn emscripten_clear_interval(id: c_int) void;
pub extern fn emscripten_runtime_keepalive_push() void;
pub extern fn emscripten_runtime_keepalive_pop() void;
pub extern fn emscripten_runtime_keepalive_check() bool;
pub const ptrdiff_t = c_long;
pub const rsize_t = c_ulong;
pub const max_align_t = c_longdouble;
pub extern fn emscripten_console_log(utf8String: [*c]const u8) void;
pub extern fn emscripten_console_warn(utf8String: [*c]const u8) void;
pub extern fn emscripten_console_error(utf8String: [*c]const u8) void;
pub extern fn emscripten_console_trace(utf8String: [*c]const u8) void;
pub extern fn emscripten_out(utf8String: [*c]const u8) void;
pub extern fn emscripten_err(utf8String: [*c]const u8) void;
pub extern fn emscripten_dbg(utf8String: [*c]const u8) void;
pub extern fn emscripten_dbg_backtrace(utf8String: [*c]const u8) void;
pub extern fn emscripten_outn(utf8String: [*c]const u8, len: usize) void;
pub extern fn emscripten_errn(utf8String: [*c]const u8, len: usize) void;
pub extern fn emscripten_dbgn(utf8String: [*c]const u8, len: usize) void;
pub extern fn emscripten_console_logf(format: [*c]const u8, ...) void;
pub extern fn emscripten_console_warnf(format: [*c]const u8, ...) void;
pub extern fn emscripten_console_errorf(format: [*c]const u8, ...) void;
pub extern fn emscripten_console_tracef(format: [*c]const u8, ...) void;
pub extern fn emscripten_outf(format: [*c]const u8, ...) void;
pub extern fn emscripten_errf(format: [*c]const u8, ...) void;
pub extern fn emscripten_dbgf(format: [*c]const u8, ...) void;
pub extern fn emscripten_dbg_backtracef(format: [*c]const u8, ...) void;
pub const struct_EmscriptenKeyboardEvent = extern struct {
    timestamp: f64 = @import("std").mem.zeroes(f64),
    location: c_uint = @import("std").mem.zeroes(c_uint),
    ctrlKey: bool = @import("std").mem.zeroes(bool),
    shiftKey: bool = @import("std").mem.zeroes(bool),
    altKey: bool = @import("std").mem.zeroes(bool),
    metaKey: bool = @import("std").mem.zeroes(bool),
    repeat: bool = @import("std").mem.zeroes(bool),
    charCode: c_uint = @import("std").mem.zeroes(c_uint),
    keyCode: c_uint = @import("std").mem.zeroes(c_uint),
    which: c_uint = @import("std").mem.zeroes(c_uint),
    key: [32]u8 = @import("std").mem.zeroes([32]u8),
    code: [32]u8 = @import("std").mem.zeroes([32]u8),
    charValue: [32]u8 = @import("std").mem.zeroes([32]u8),
    locale: [32]u8 = @import("std").mem.zeroes([32]u8),
};
pub const EmscriptenKeyboardEvent = struct_EmscriptenKeyboardEvent;
pub const em_key_callback_func = ?*const fn (c_int, [*c]const EmscriptenKeyboardEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_keypress_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_key_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_keydown_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_key_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_keyup_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_key_callback_func, targetThread: pthread_t) c_int;
pub const struct_EmscriptenMouseEvent = extern struct {
    timestamp: f64 = @import("std").mem.zeroes(f64),
    screenX: c_int = @import("std").mem.zeroes(c_int),
    screenY: c_int = @import("std").mem.zeroes(c_int),
    clientX: c_int = @import("std").mem.zeroes(c_int),
    clientY: c_int = @import("std").mem.zeroes(c_int),
    ctrlKey: bool = @import("std").mem.zeroes(bool),
    shiftKey: bool = @import("std").mem.zeroes(bool),
    altKey: bool = @import("std").mem.zeroes(bool),
    metaKey: bool = @import("std").mem.zeroes(bool),
    button: c_ushort = @import("std").mem.zeroes(c_ushort),
    buttons: c_ushort = @import("std").mem.zeroes(c_ushort),
    movementX: c_int = @import("std").mem.zeroes(c_int),
    movementY: c_int = @import("std").mem.zeroes(c_int),
    targetX: c_int = @import("std").mem.zeroes(c_int),
    targetY: c_int = @import("std").mem.zeroes(c_int),
    canvasX: c_int = @import("std").mem.zeroes(c_int),
    canvasY: c_int = @import("std").mem.zeroes(c_int),
    padding: c_int = @import("std").mem.zeroes(c_int),
};
pub const EmscriptenMouseEvent = struct_EmscriptenMouseEvent;
pub const em_mouse_callback_func = ?*const fn (c_int, [*c]const EmscriptenMouseEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_click_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_mouse_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_mousedown_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_mouse_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_mouseup_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_mouse_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_dblclick_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_mouse_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_mousemove_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_mouse_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_mouseenter_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_mouse_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_mouseleave_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_mouse_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_mouseover_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_mouse_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_mouseout_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_mouse_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_get_mouse_status(mouseState: [*c]EmscriptenMouseEvent) c_int;
pub const struct_EmscriptenWheelEvent = extern struct {
    mouse: EmscriptenMouseEvent = @import("std").mem.zeroes(EmscriptenMouseEvent),
    deltaX: f64 = @import("std").mem.zeroes(f64),
    deltaY: f64 = @import("std").mem.zeroes(f64),
    deltaZ: f64 = @import("std").mem.zeroes(f64),
    deltaMode: c_uint = @import("std").mem.zeroes(c_uint),
};
pub const EmscriptenWheelEvent = struct_EmscriptenWheelEvent;
pub const em_wheel_callback_func = ?*const fn (c_int, [*c]const EmscriptenWheelEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_wheel_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_wheel_callback_func, targetThread: pthread_t) c_int;
pub const struct_EmscriptenUiEvent = extern struct {
    detail: c_int = @import("std").mem.zeroes(c_int),
    documentBodyClientWidth: c_int = @import("std").mem.zeroes(c_int),
    documentBodyClientHeight: c_int = @import("std").mem.zeroes(c_int),
    windowInnerWidth: c_int = @import("std").mem.zeroes(c_int),
    windowInnerHeight: c_int = @import("std").mem.zeroes(c_int),
    windowOuterWidth: c_int = @import("std").mem.zeroes(c_int),
    windowOuterHeight: c_int = @import("std").mem.zeroes(c_int),
    scrollTop: c_int = @import("std").mem.zeroes(c_int),
    scrollLeft: c_int = @import("std").mem.zeroes(c_int),
};
pub const EmscriptenUiEvent = struct_EmscriptenUiEvent;
pub const em_ui_callback_func = ?*const fn (c_int, [*c]const EmscriptenUiEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_resize_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_ui_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_scroll_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_ui_callback_func, targetThread: pthread_t) c_int;
pub const struct_EmscriptenFocusEvent = extern struct {
    nodeName: [128]u8 = @import("std").mem.zeroes([128]u8),
    id: [128]u8 = @import("std").mem.zeroes([128]u8),
};
pub const EmscriptenFocusEvent = struct_EmscriptenFocusEvent;
pub const em_focus_callback_func = ?*const fn (c_int, [*c]const EmscriptenFocusEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_blur_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_focus_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_focus_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_focus_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_focusin_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_focus_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_focusout_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_focus_callback_func, targetThread: pthread_t) c_int;
pub const struct_EmscriptenDeviceOrientationEvent = extern struct {
    alpha: f64 = @import("std").mem.zeroes(f64),
    beta: f64 = @import("std").mem.zeroes(f64),
    gamma: f64 = @import("std").mem.zeroes(f64),
    absolute: bool = @import("std").mem.zeroes(bool),
};
pub const EmscriptenDeviceOrientationEvent = struct_EmscriptenDeviceOrientationEvent;
pub const em_deviceorientation_callback_func = ?*const fn (c_int, [*c]const EmscriptenDeviceOrientationEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_deviceorientation_callback_on_thread(userData: ?*anyopaque, useCapture: bool, callback: em_deviceorientation_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_get_deviceorientation_status(orientationState: [*c]EmscriptenDeviceOrientationEvent) c_int;
pub const struct_EmscriptenDeviceMotionEvent = extern struct {
    accelerationX: f64 = @import("std").mem.zeroes(f64),
    accelerationY: f64 = @import("std").mem.zeroes(f64),
    accelerationZ: f64 = @import("std").mem.zeroes(f64),
    accelerationIncludingGravityX: f64 = @import("std").mem.zeroes(f64),
    accelerationIncludingGravityY: f64 = @import("std").mem.zeroes(f64),
    accelerationIncludingGravityZ: f64 = @import("std").mem.zeroes(f64),
    rotationRateAlpha: f64 = @import("std").mem.zeroes(f64),
    rotationRateBeta: f64 = @import("std").mem.zeroes(f64),
    rotationRateGamma: f64 = @import("std").mem.zeroes(f64),
    supportedFields: c_int = @import("std").mem.zeroes(c_int),
};
pub const EmscriptenDeviceMotionEvent = struct_EmscriptenDeviceMotionEvent;
pub const em_devicemotion_callback_func = ?*const fn (c_int, [*c]const EmscriptenDeviceMotionEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_devicemotion_callback_on_thread(userData: ?*anyopaque, useCapture: bool, callback: em_devicemotion_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_get_devicemotion_status(motionState: [*c]EmscriptenDeviceMotionEvent) c_int;
pub const struct_EmscriptenOrientationChangeEvent = extern struct {
    orientationIndex: c_int = @import("std").mem.zeroes(c_int),
    orientationAngle: c_int = @import("std").mem.zeroes(c_int),
};
pub const EmscriptenOrientationChangeEvent = struct_EmscriptenOrientationChangeEvent;
pub const em_orientationchange_callback_func = ?*const fn (c_int, [*c]const EmscriptenOrientationChangeEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_orientationchange_callback_on_thread(userData: ?*anyopaque, useCapture: bool, callback: em_orientationchange_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_get_orientation_status(orientationStatus: [*c]EmscriptenOrientationChangeEvent) c_int;
pub extern fn emscripten_lock_orientation(allowedOrientations: c_int) c_int;
pub extern fn emscripten_unlock_orientation() c_int;
pub const struct_EmscriptenFullscreenChangeEvent = extern struct {
    isFullscreen: bool = @import("std").mem.zeroes(bool),
    fullscreenEnabled: bool = @import("std").mem.zeroes(bool),
    nodeName: [128]u8 = @import("std").mem.zeroes([128]u8),
    id: [128]u8 = @import("std").mem.zeroes([128]u8),
    elementWidth: c_int = @import("std").mem.zeroes(c_int),
    elementHeight: c_int = @import("std").mem.zeroes(c_int),
    screenWidth: c_int = @import("std").mem.zeroes(c_int),
    screenHeight: c_int = @import("std").mem.zeroes(c_int),
};
pub const EmscriptenFullscreenChangeEvent = struct_EmscriptenFullscreenChangeEvent;
pub const em_fullscreenchange_callback_func = ?*const fn (c_int, [*c]const EmscriptenFullscreenChangeEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_fullscreenchange_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_fullscreenchange_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_get_fullscreen_status(fullscreenStatus: [*c]EmscriptenFullscreenChangeEvent) c_int;
pub const em_canvasresized_callback_func = ?*const fn (c_int, ?*const anyopaque, ?*anyopaque) callconv(.c) bool;
pub const struct_EmscriptenFullscreenStrategy = extern struct {
    scaleMode: c_int = @import("std").mem.zeroes(c_int),
    canvasResolutionScaleMode: c_int = @import("std").mem.zeroes(c_int),
    filteringMode: c_int = @import("std").mem.zeroes(c_int),
    canvasResizedCallback: em_canvasresized_callback_func = @import("std").mem.zeroes(em_canvasresized_callback_func),
    canvasResizedCallbackUserData: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    canvasResizedCallbackTargetThread: pthread_t = @import("std").mem.zeroes(pthread_t),
};
pub const EmscriptenFullscreenStrategy = struct_EmscriptenFullscreenStrategy;
pub extern fn emscripten_request_fullscreen(target: [*c]const u8, deferUntilInEventHandler: bool) c_int;
pub extern fn emscripten_request_fullscreen_strategy(target: [*c]const u8, deferUntilInEventHandler: bool, fullscreenStrategy: [*c]const EmscriptenFullscreenStrategy) c_int;
pub extern fn emscripten_exit_fullscreen() c_int;
pub extern fn emscripten_enter_soft_fullscreen(target: [*c]const u8, fullscreenStrategy: [*c]const EmscriptenFullscreenStrategy) c_int;
pub extern fn emscripten_exit_soft_fullscreen() c_int;
pub const struct_EmscriptenPointerlockChangeEvent = extern struct {
    isActive: bool = @import("std").mem.zeroes(bool),
    nodeName: [128]u8 = @import("std").mem.zeroes([128]u8),
    id: [128]u8 = @import("std").mem.zeroes([128]u8),
};
pub const EmscriptenPointerlockChangeEvent = struct_EmscriptenPointerlockChangeEvent;
pub const em_pointerlockchange_callback_func = ?*const fn (c_int, [*c]const EmscriptenPointerlockChangeEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_pointerlockchange_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_pointerlockchange_callback_func, targetThread: pthread_t) c_int;
pub const em_pointerlockerror_callback_func = ?*const fn (c_int, ?*const anyopaque, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_pointerlockerror_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_pointerlockerror_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_get_pointerlock_status(pointerlockStatus: [*c]EmscriptenPointerlockChangeEvent) c_int;
pub extern fn emscripten_request_pointerlock(target: [*c]const u8, deferUntilInEventHandler: bool) c_int;
pub extern fn emscripten_exit_pointerlock() c_int;
pub const struct_EmscriptenVisibilityChangeEvent = extern struct {
    hidden: bool = @import("std").mem.zeroes(bool),
    visibilityState: c_int = @import("std").mem.zeroes(c_int),
};
pub const EmscriptenVisibilityChangeEvent = struct_EmscriptenVisibilityChangeEvent;
pub const em_visibilitychange_callback_func = ?*const fn (c_int, [*c]const EmscriptenVisibilityChangeEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_visibilitychange_callback_on_thread(userData: ?*anyopaque, useCapture: bool, callback: em_visibilitychange_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_get_visibility_status(visibilityStatus: [*c]EmscriptenVisibilityChangeEvent) c_int;
pub const struct_EmscriptenTouchPoint = extern struct {
    identifier: c_int = @import("std").mem.zeroes(c_int),
    screenX: c_int = @import("std").mem.zeroes(c_int),
    screenY: c_int = @import("std").mem.zeroes(c_int),
    clientX: c_int = @import("std").mem.zeroes(c_int),
    clientY: c_int = @import("std").mem.zeroes(c_int),
    pageX: c_int = @import("std").mem.zeroes(c_int),
    pageY: c_int = @import("std").mem.zeroes(c_int),
    isChanged: bool = @import("std").mem.zeroes(bool),
    onTarget: bool = @import("std").mem.zeroes(bool),
    targetX: c_int = @import("std").mem.zeroes(c_int),
    targetY: c_int = @import("std").mem.zeroes(c_int),
    canvasX: c_int = @import("std").mem.zeroes(c_int),
    canvasY: c_int = @import("std").mem.zeroes(c_int),
};
pub const EmscriptenTouchPoint = struct_EmscriptenTouchPoint;
pub const struct_EmscriptenTouchEvent = extern struct {
    timestamp: f64 = @import("std").mem.zeroes(f64),
    numTouches: c_int = @import("std").mem.zeroes(c_int),
    ctrlKey: bool = @import("std").mem.zeroes(bool),
    shiftKey: bool = @import("std").mem.zeroes(bool),
    altKey: bool = @import("std").mem.zeroes(bool),
    metaKey: bool = @import("std").mem.zeroes(bool),
    touches: [32]EmscriptenTouchPoint = @import("std").mem.zeroes([32]EmscriptenTouchPoint),
};
pub const EmscriptenTouchEvent = struct_EmscriptenTouchEvent;
pub const em_touch_callback_func = ?*const fn (c_int, [*c]const EmscriptenTouchEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_touchstart_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_touch_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_touchend_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_touch_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_touchmove_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_touch_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_touchcancel_callback_on_thread(target: [*c]const u8, userData: ?*anyopaque, useCapture: bool, callback: em_touch_callback_func, targetThread: pthread_t) c_int;
pub const struct_EmscriptenGamepadEvent = extern struct {
    timestamp: f64 = @import("std").mem.zeroes(f64),
    numAxes: c_int = @import("std").mem.zeroes(c_int),
    numButtons: c_int = @import("std").mem.zeroes(c_int),
    axis: [64]f64 = @import("std").mem.zeroes([64]f64),
    analogButton: [64]f64 = @import("std").mem.zeroes([64]f64),
    digitalButton: [64]bool = @import("std").mem.zeroes([64]bool),
    connected: bool = @import("std").mem.zeroes(bool),
    index: c_int = @import("std").mem.zeroes(c_int),
    id: [64]u8 = @import("std").mem.zeroes([64]u8),
    mapping: [64]u8 = @import("std").mem.zeroes([64]u8),
};
pub const EmscriptenGamepadEvent = struct_EmscriptenGamepadEvent;
pub const em_gamepad_callback_func = ?*const fn (c_int, [*c]const EmscriptenGamepadEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_gamepadconnected_callback_on_thread(userData: ?*anyopaque, useCapture: bool, callback: em_gamepad_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_gamepaddisconnected_callback_on_thread(userData: ?*anyopaque, useCapture: bool, callback: em_gamepad_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_sample_gamepad_data() c_int;
pub extern fn emscripten_get_num_gamepads() c_int;
pub extern fn emscripten_get_gamepad_status(index: c_int, gamepadState: [*c]EmscriptenGamepadEvent) c_int;
pub const struct_EmscriptenBatteryEvent = extern struct {
    chargingTime: f64 = @import("std").mem.zeroes(f64),
    dischargingTime: f64 = @import("std").mem.zeroes(f64),
    level: f64 = @import("std").mem.zeroes(f64),
    charging: bool = @import("std").mem.zeroes(bool),
};
pub const EmscriptenBatteryEvent = struct_EmscriptenBatteryEvent;
pub const em_battery_callback_func = ?*const fn (c_int, [*c]const EmscriptenBatteryEvent, ?*anyopaque) callconv(.c) bool;
pub extern fn emscripten_set_batterychargingchange_callback_on_thread(userData: ?*anyopaque, callback: em_battery_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_batterylevelchange_callback_on_thread(userData: ?*anyopaque, callback: em_battery_callback_func, targetThread: pthread_t) c_int;
pub extern fn emscripten_get_battery_status(batteryState: [*c]EmscriptenBatteryEvent) c_int;
pub extern fn emscripten_vibrate(msecs: c_int) c_int;
pub extern fn emscripten_vibrate_pattern(msecsArray: [*c]c_int, numEntries: c_int) c_int;
pub const em_beforeunload_callback = ?*const fn (c_int, ?*const anyopaque, ?*anyopaque) callconv(.c) [*c]const u8;
pub extern fn emscripten_set_beforeunload_callback_on_thread(userData: ?*anyopaque, callback: em_beforeunload_callback, targetThread: pthread_t) c_int;
pub extern fn emscripten_set_canvas_element_size(target: [*c]const u8, width: c_int, height: c_int) c_int;
pub extern fn emscripten_get_canvas_element_size(target: [*c]const u8, width: [*c]c_int, height: [*c]c_int) c_int;
pub extern fn emscripten_set_element_css_size(target: [*c]const u8, width: f64, height: f64) c_int;
pub extern fn emscripten_get_element_css_size(target: [*c]const u8, width: [*c]f64, height: [*c]f64) c_int;
pub extern fn emscripten_html5_remove_all_event_listeners() void;
pub extern fn emscripten_request_animation_frame(cb: ?*const fn (f64, ?*anyopaque) callconv(.c) bool, userData: ?*anyopaque) c_int;
pub extern fn emscripten_cancel_animation_frame(requestAnimationFrameId: c_int) void;
pub extern fn emscripten_request_animation_frame_loop(cb: ?*const fn (f64, ?*anyopaque) callconv(.c) bool, userData: ?*anyopaque) void;
pub extern fn emscripten_date_now() f64;
pub extern fn emscripten_performance_now() f64;
...
pub inline fn _emscripten_out(x: anytype) @TypeOf(emscripten_out(x)) {
    _ = &x;
    return emscripten_out(x);
}
pub inline fn _emscripten_err(x: anytype) @TypeOf(emscripten_err(x)) {
    _ = &x;
    return emscripten_err(x);
}
pub inline fn _emscripten_dbg(x: anytype) @TypeOf(emscripten_dbg(x)) {
    _ = &x;
    return emscripten_dbg(x);
}
pub const _emscripten_outf = @compileError("unable to translate C expr: expected ')' instead got '...'");
// stub/emscripten/console.h:55:9
pub const _emscripten_errf = @compileError("unable to translate C expr: expected ')' instead got '...'");
// stub/emscripten/console.h:56:9
pub const _emscripten_dbgf = @compileError("unable to translate C expr: expected ')' instead got '...'");
// stub/emscripten/console.h:57:9
pub const EMSCRIPTEN_EVENT_KEYPRESS = @as(c_int, 1);
pub const EMSCRIPTEN_EVENT_KEYDOWN = @as(c_int, 2);
pub const EMSCRIPTEN_EVENT_KEYUP = @as(c_int, 3);
pub const EMSCRIPTEN_EVENT_CLICK = @as(c_int, 4);
pub const EMSCRIPTEN_EVENT_MOUSEDOWN = @as(c_int, 5);
pub const EMSCRIPTEN_EVENT_MOUSEUP = @as(c_int, 6);
pub const EMSCRIPTEN_EVENT_DBLCLICK = @as(c_int, 7);
pub const EMSCRIPTEN_EVENT_MOUSEMOVE = @as(c_int, 8);
pub const EMSCRIPTEN_EVENT_WHEEL = @as(c_int, 9);
pub const EMSCRIPTEN_EVENT_RESIZE = @as(c_int, 10);
pub const EMSCRIPTEN_EVENT_SCROLL = @as(c_int, 11);
pub const EMSCRIPTEN_EVENT_BLUR = @as(c_int, 12);
pub const EMSCRIPTEN_EVENT_FOCUS = @as(c_int, 13);
pub const EMSCRIPTEN_EVENT_FOCUSIN = @as(c_int, 14);
pub const EMSCRIPTEN_EVENT_FOCUSOUT = @as(c_int, 15);
pub const EMSCRIPTEN_EVENT_DEVICEORIENTATION = @as(c_int, 16);
pub const EMSCRIPTEN_EVENT_DEVICEMOTION = @as(c_int, 17);
pub const EMSCRIPTEN_EVENT_ORIENTATIONCHANGE = @as(c_int, 18);
pub const EMSCRIPTEN_EVENT_FULLSCREENCHANGE = @as(c_int, 19);
pub const EMSCRIPTEN_EVENT_POINTERLOCKCHANGE = @as(c_int, 20);
pub const EMSCRIPTEN_EVENT_VISIBILITYCHANGE = @as(c_int, 21);
pub const EMSCRIPTEN_EVENT_TOUCHSTART = @as(c_int, 22);
pub const EMSCRIPTEN_EVENT_TOUCHEND = @as(c_int, 23);
pub const EMSCRIPTEN_EVENT_TOUCHMOVE = @as(c_int, 24);
pub const EMSCRIPTEN_EVENT_TOUCHCANCEL = @as(c_int, 25);
pub const EMSCRIPTEN_EVENT_GAMEPADCONNECTED = @as(c_int, 26);
pub const EMSCRIPTEN_EVENT_GAMEPADDISCONNECTED = @as(c_int, 27);
pub const EMSCRIPTEN_EVENT_BEFOREUNLOAD = @as(c_int, 28);
pub const EMSCRIPTEN_EVENT_BATTERYCHARGINGCHANGE = @as(c_int, 29);
pub const EMSCRIPTEN_EVENT_BATTERYLEVELCHANGE = @as(c_int, 30);
pub const EMSCRIPTEN_EVENT_WEBGLCONTEXTLOST = @as(c_int, 31);
pub const EMSCRIPTEN_EVENT_WEBGLCONTEXTRESTORED = @as(c_int, 32);
pub const EMSCRIPTEN_EVENT_MOUSEENTER = @as(c_int, 33);
pub const EMSCRIPTEN_EVENT_MOUSELEAVE = @as(c_int, 34);
pub const EMSCRIPTEN_EVENT_MOUSEOVER = @as(c_int, 35);
pub const EMSCRIPTEN_EVENT_MOUSEOUT = @as(c_int, 36);
pub const EMSCRIPTEN_EVENT_CANVASRESIZED = @as(c_int, 37);
pub const EMSCRIPTEN_EVENT_POINTERLOCKERROR = @as(c_int, 38);
pub const EMSCRIPTEN_EVENT_TARGET_INVALID = @as(c_int, 0);
pub const EMSCRIPTEN_EVENT_TARGET_DOCUMENT = @compileError("unable to translate C expr: unexpected token 'const'");
// emscripten/html5.h:75:9
pub const EMSCRIPTEN_EVENT_TARGET_WINDOW = @compileError("unable to translate C expr: unexpected token 'const'");
// emscripten/html5.h:76:9
pub const EMSCRIPTEN_EVENT_TARGET_SCREEN = @compileError("unable to translate C expr: unexpected token 'const'");
// emscripten/html5.h:77:9
pub const DOM_KEY_LOCATION = c_int;
pub const DOM_KEY_LOCATION_STANDARD = @as(c_int, 0x00);
pub const DOM_KEY_LOCATION_LEFT = @as(c_int, 0x01);
pub const DOM_KEY_LOCATION_RIGHT = @as(c_int, 0x02);
pub const DOM_KEY_LOCATION_NUMPAD = @as(c_int, 0x03);
pub const EM_HTML5_SHORT_STRING_LEN_BYTES = @as(c_int, 32);
pub const EM_HTML5_MEDIUM_STRING_LEN_BYTES = @as(c_int, 64);
pub const EM_HTML5_LONG_STRING_LEN_BYTES = @as(c_int, 128);
pub const DOM_DELTA_PIXEL = @as(c_int, 0x00);
pub const DOM_DELTA_LINE = @as(c_int, 0x01);
pub const DOM_DELTA_PAGE = @as(c_int, 0x02);
pub const EMSCRIPTEN_DEVICE_MOTION_EVENT_SUPPORTS_ACCELERATION = @as(c_int, 0x01);
pub const EMSCRIPTEN_DEVICE_MOTION_EVENT_SUPPORTS_ACCELERATION_INCLUDING_GRAVITY = @as(c_int, 0x02);
pub const EMSCRIPTEN_DEVICE_MOTION_EVENT_SUPPORTS_ROTATION_RATE = @as(c_int, 0x04);
pub const EMSCRIPTEN_ORIENTATION_UNSUPPORTED = @as(c_int, 0);
pub const EMSCRIPTEN_ORIENTATION_PORTRAIT_PRIMARY = @as(c_int, 1);
pub const EMSCRIPTEN_ORIENTATION_PORTRAIT_SECONDARY = @as(c_int, 2);
pub const EMSCRIPTEN_ORIENTATION_LANDSCAPE_PRIMARY = @as(c_int, 4);
pub const EMSCRIPTEN_ORIENTATION_LANDSCAPE_SECONDARY = @as(c_int, 8);
pub const EMSCRIPTEN_FULLSCREEN_SCALE = c_int;
pub const EMSCRIPTEN_FULLSCREEN_SCALE_DEFAULT = @as(c_int, 0);
pub const EMSCRIPTEN_FULLSCREEN_SCALE_STRETCH = @as(c_int, 1);
pub const EMSCRIPTEN_FULLSCREEN_SCALE_ASPECT = @as(c_int, 2);
pub const EMSCRIPTEN_FULLSCREEN_SCALE_CENTER = @as(c_int, 3);
pub const EMSCRIPTEN_FULLSCREEN_CANVAS_SCALE = c_int;
pub const EMSCRIPTEN_FULLSCREEN_CANVAS_SCALE_NONE = @as(c_int, 0);
pub const EMSCRIPTEN_FULLSCREEN_CANVAS_SCALE_STDDEF = @as(c_int, 1);
pub const EMSCRIPTEN_FULLSCREEN_CANVAS_SCALE_HIDEF = @as(c_int, 2);
pub const EMSCRIPTEN_FULLSCREEN_FILTERING = c_int;
pub const EMSCRIPTEN_FULLSCREEN_FILTERING_DEFAULT = @as(c_int, 0);
pub const EMSCRIPTEN_FULLSCREEN_FILTERING_NEAREST = @as(c_int, 1);
pub const EMSCRIPTEN_FULLSCREEN_FILTERING_BILINEAR = @as(c_int, 2);
pub const EMSCRIPTEN_VISIBILITY_HIDDEN = @as(c_int, 0);
pub const EMSCRIPTEN_VISIBILITY_VISIBLE = @as(c_int, 1);
pub const EMSCRIPTEN_VISIBILITY_PRERENDER = @as(c_int, 2);
pub const EMSCRIPTEN_VISIBILITY_UNLOADED = @as(c_int, 3);
pub const EM_CALLBACK_THREAD_CONTEXT_MAIN_RUNTIME_THREAD = @import("std").zig.c_translation.cast(pthread_t, @as(c_int, 0x1));
pub const EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD = @import("std").zig.c_translation.cast(pthread_t, @as(c_int, 0x2));
pub const EM_CALLBACK_THREAD_CONTEXT_MAIN_BROWSER_THREAD = EM_CALLBACK_THREAD_CONTEXT_MAIN_RUNTIME_THREAD;
pub inline fn emscripten_set_keypress_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_keypress_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_keypress_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_keydown_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_keydown_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_keydown_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_keyup_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_keyup_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_keyup_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_click_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_click_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_click_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_mousedown_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_mousedown_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_mousedown_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_mouseup_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_mouseup_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_mouseup_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_dblclick_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_dblclick_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_dblclick_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_mousemove_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_mousemove_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_mousemove_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_mouseenter_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_mouseenter_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_mouseenter_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_mouseleave_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_mouseleave_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_mouseleave_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_mouseover_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_mouseover_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_mouseover_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_mouseout_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_mouseout_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_mouseout_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_wheel_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_wheel_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_wheel_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_resize_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_resize_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_resize_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_scroll_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_scroll_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_scroll_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_blur_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_blur_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_blur_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_focus_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_focus_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_focus_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_focusin_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_focusin_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_focusin_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_focusout_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_focusout_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_focusout_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_deviceorientation_callback(userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_deviceorientation_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_deviceorientation_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_devicemotion_callback(userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_devicemotion_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_devicemotion_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_orientationchange_callback(userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_orientationchange_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_orientationchange_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_fullscreenchange_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_fullscreenchange_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_fullscreenchange_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_pointerlockchange_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_pointerlockchange_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_pointerlockchange_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_pointerlockerror_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_pointerlockerror_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_pointerlockerror_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_visibilitychange_callback(userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_visibilitychange_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_visibilitychange_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_touchstart_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_touchstart_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_touchstart_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_touchend_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_touchend_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_touchend_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_touchmove_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_touchmove_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_touchmove_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_touchcancel_callback(target: anytype, userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_touchcancel_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &target;
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_touchcancel_callback_on_thread(target, userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_gamepadconnected_callback(userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_gamepadconnected_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_gamepadconnected_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_gamepaddisconnected_callback(userData: anytype, useCapture: anytype, callback: anytype) @TypeOf(emscripten_set_gamepaddisconnected_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &userData;
    _ = &useCapture;
    _ = &callback;
    return emscripten_set_gamepaddisconnected_callback_on_thread(userData, useCapture, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_batterychargingchange_callback(userData: anytype, callback: anytype) @TypeOf(emscripten_set_batterychargingchange_callback_on_thread(userData, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &userData;
    _ = &callback;
    return emscripten_set_batterychargingchange_callback_on_thread(userData, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_batterylevelchange_callback(userData: anytype, callback: anytype) @TypeOf(emscripten_set_batterylevelchange_callback_on_thread(userData, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD)) {
    _ = &userData;
    _ = &callback;
    return emscripten_set_batterylevelchange_callback_on_thread(userData, callback, EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
}
pub inline fn emscripten_set_beforeunload_callback(userData: anytype, callback: anytype) @TypeOf(emscripten_set_beforeunload_callback_on_thread(userData, callback, EM_CALLBACK_THREAD_CONTEXT_MAIN_RUNTIME_THREAD)) {
    _ = &userData;
    _ = &callback;
    return emscripten_set_beforeunload_callback_on_thread(userData, callback, EM_CALLBACK_THREAD_CONTEXT_MAIN_RUNTIME_THREAD);
}
