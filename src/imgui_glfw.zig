...
pub extern fn cImGui_ImplGlfw_InitForOpenGL(window: ?*GLFWwindow, install_callbacks: bool) bool;
pub extern fn cImGui_ImplGlfw_InitForVulkan(window: ?*GLFWwindow, install_callbacks: bool) bool;
pub extern fn cImGui_ImplGlfw_InitForOther(window: ?*GLFWwindow, install_callbacks: bool) bool;
pub extern fn cImGui_ImplGlfw_Shutdown() void;
pub extern fn cImGui_ImplGlfw_NewFrame() void;
pub extern fn cImGui_ImplGlfw_InstallEmscriptenCallbacks(window: ?*GLFWwindow, canvas_selector: [*c]const u8) void;
pub extern fn cImGui_ImplGlfw_InstallCallbacks(window: ?*GLFWwindow) void;
pub extern fn cImGui_ImplGlfw_RestoreCallbacks(window: ?*GLFWwindow) void;
pub extern fn cImGui_ImplGlfw_SetCallbacksChainForAllWindows(chain_for_all_windows: bool) void;
pub extern fn cImGui_ImplGlfw_WindowFocusCallback(window: ?*GLFWwindow, focused: c_int) void;
pub extern fn cImGui_ImplGlfw_CursorEnterCallback(window: ?*GLFWwindow, entered: c_int) void;
pub extern fn cImGui_ImplGlfw_CursorPosCallback(window: ?*GLFWwindow, x: f64, y: f64) void;
pub extern fn cImGui_ImplGlfw_MouseButtonCallback(window: ?*GLFWwindow, button: c_int, action: c_int, mods: c_int) void;
pub extern fn cImGui_ImplGlfw_ScrollCallback(window: ?*GLFWwindow, xoffset: f64, yoffset: f64) void;
pub extern fn cImGui_ImplGlfw_KeyCallback(window: ?*GLFWwindow, key: c_int, scancode: c_int, action: c_int, mods: c_int) void;
pub extern fn cImGui_ImplGlfw_CharCallback(window: ?*GLFWwindow, c: c_uint) void;
pub extern fn cImGui_ImplGlfw_MonitorCallback(monitor: ?*GLFWmonitor, event: c_int) void;
pub extern fn cImGui_ImplGlfw_Sleep(milliseconds: c_int) void;
