...
//based on imgui.h file version "1.92.0 WIP" 19196 from Dear ImGui https://github.com/ocornut/imgui
...
CIMGUI_API void ImFont_AddRemapChar(ImFont* self,ImWchar from_codepoint,ImWchar to_codepoint,bool overwrite_dst);
